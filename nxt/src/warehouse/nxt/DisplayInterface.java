...
public interface DisplayInterface {
	...
	public void pickUp(int quantity, int weight);	// draws the pick up phase
	...
	public void directionUpdate(String direction);	// Changes the direction displayed according to the robot motion					
